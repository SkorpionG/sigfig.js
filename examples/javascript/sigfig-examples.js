...
import { sigfigOf, toSigfig, toPrecision } from "../../dist/index.js";
...
const measurement1 = 12.345;
const measurement2 = 12.3;
const measurement3 = 12;
...
const data = [123.456, 0.001234, 9876.54, 0.0999];
...
const avogadroNumber = 6.02214076e23; // mol⁻¹
...
const measurements = [10.123, 10.1, 10.12345, 10];
const targetSigFigs = 3;

console.log(`  Standardizing measurements to ${targetSigFigs} significant figures:`);
measurements.forEach((m) => {
  const standardized = toSigfig(m, targetSigFigs);
